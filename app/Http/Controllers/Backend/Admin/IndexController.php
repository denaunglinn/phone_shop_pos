...
class IndexController extends Controller
{
    ...
    {
        $selected_item_category = ItemCategory::find($request->item_category);
        $selected_customer = User::find($request->customer);
        ...
        return view('backend.admin.indec1', compact('products','cart_data','data_total','selected_customer','cart','selected_item_category'));
    }
