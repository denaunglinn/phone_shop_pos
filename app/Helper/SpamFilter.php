...
// usage link: https://github.com/naywin-programmer/PhpSpamFilter
...
class SpamFilter
{
    ...
    {
        $this->urls = config('spam_filter.urls');
        $this->keywords = config('spam_filter.keywords');
        $this->default_filter_size = config('spam_filter.default_filter_size');
    }
