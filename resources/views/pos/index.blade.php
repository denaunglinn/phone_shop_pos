                        ...
                        <div style="width: 16.66%;border:1px solid rgb(243, 243, 243)" class="mb-4">
                            <div class="productCard">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text text-center">MMK. {{ number_format($product->price,2,',','.') }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">MMK. {{ number_format($item['price'],2,',','.') }}</td>
                                </tr>
                                @empty
                                <tr>
        ...
        <!-- Sorry campur2 bahasa indonesia sama inggris krn kebiasaan make b.inggris eh ternyata buat aplikasi buat indonesia jadi gini deh  -->
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h1 class="font-weight-bold mb-5">MMK. {{ number_format($data_total['total'],2,',','.') }}</h1>
