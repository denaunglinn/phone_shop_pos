...
@section('meta_title', 'Add Return Item')
@section('page_title')
@lang("message.header.add_return_item")
@endsection
...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <form action="{{ route('admin.return_items.store') }}" method="post" id="create" enctype="multipart/form-data">
                    @csrf
                    <div class="container">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <select name="return_type" id="" class="form-control">
                                        <option value="0">Buying Return</option>
                                        <option value="1">Sale Return</option>
                                    </select>
                                </div>
                            </div>
