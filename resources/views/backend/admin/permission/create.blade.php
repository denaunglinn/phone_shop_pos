...
@section('meta_title', 'Create '.$name.' Permission')
@section('page_title', 'Create '.$name.' Permission')
...
<section class="content pb-3">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('admin.permission.store') }}?guard={{request('guard')}}" autocomplete="off"
