    ...
    var render = {
        ...
        initList: function initList() {
            ...
            forEach(this.images, function (image, index) {
                var src = image.src;
                var alt = escapeHTMLEntities(
                    image.alt || getImageNameFromURL(src)
                );
                var url = options.url;
    ...
    var handlers = {
        ...
        pointerdown: function pointerdown(event) {
            ...
            if (
                ...
                this.showing ||
                this.viewing ||
                this.hiding || // No primary button (Usually the left button)
                ...
                [
                    {
                        ...
                        value: function init() {
                            ...
                            this.initialBodyPaddingRight = window.getComputedStyle(
                                body
                            ).paddingRight; // Override `transition` option if it is not supported
                        ...
                        value: function build() {
                            ...
                            if (options.inline) {
                                ...
                                if (isString(container)) {
                                    container = element.ownerDocument.querySelector(
                                        container
                                    );
                                }
